...
One single full-slice call per shield — One Shield's own narration
provides the investigation pacing. Scope isolation holds: each shield sees only its own slice.
"""
