...
// Known Zelle recipients. "Ravi (friend)" is the seeded, previously-used payee;
// anything typed that isn't in this list becomes a first-seen payee (e.g. the
// "QuickFix Support" scam persona used in the coerced scenario).
export const KNOWN_PAYEES = [
  {
    id: 'ravi',
    name: 'RAVI SHARMA',
    display: 'Ravi (friend)',
    contact: 'ravi.sharma92@gmail.com',
    lastPaid: 'Jul 12',
  },
]
...
export const UPCOMING_TRANSACTIONS = [
  {
    date: 'Jul 28',
    description: 'Payment to ComEd - Commonwealth Edison',
    category: 'Bill pay',
...
export const PAST_TRANSACTIONS = [
  { date: 'Jul 20', description: 'RAVI SHARMA', category: 'Zelle Money Sent', amount: -300.0, balance: 6827.44 },
  { date: 'Jul 20', description: 'RAVI SHARMA', category: 'Zelle Money Sent', amount: -200.0, balance: 7127.44 },
  ...
  { date: 'Jul 16', description: 'RAVI SHARMA', category: 'Zelle Money Sent', amount: -100.0, balance: 7886.72 },
  ...
  { date: 'Jul 14', description: 'RAVI SHARMA', category: 'Zelle Money Sent', amount: -25.0, balance: 5549.12 },
]
