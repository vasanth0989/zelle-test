...
consent_declined?}), a platform-computed "signal_summary", a payment summary
("transaction"), and consent flags. Decide the bank's response.
...
- POLICY FLOOR: when signal_summary.biometrics_available is true and
  max_informative_score is below 60, the decision is "allow" (risk at most
  40) — no exceptions. Judgment decides HOW risky and WHY; it never invents
  signals the assessments do not contain.
